...
def WriteToBackup():
    backup = open('backup-football.txt', 'w')
    backup.write('{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n'.format(
        str(currenttime), team1name, team2name, str(team1score), str(team2score)))
    backup.flush()
